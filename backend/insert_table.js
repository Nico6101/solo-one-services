...
module.exports.handler = async (event, context, callback) => {
    ...
    try {
        ...
        context.succeed(CREATE_RESPONSE(200,{"status":200, "message":"data inserted successfully"}));
    }
    catch (err) {
        console.log("Error occured while entering data in ",reqbody.tablename," table : ",err)
        context.succeed(CREATE_RESPONSE(401,{"status ":401, "message":"data cannot be inserted" }));
    }
};
